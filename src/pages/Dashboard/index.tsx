  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="grow flex items-center justify-around">
        <div className="h-[50%] bg-white w-[40%] rounded-xl flex flex-col justify-around">
          <h1 className="text-center text-[3rem] text-black/60 font-bold">
            Bienvenido
          </h1>
          {isUserActive && !isLoading && !isError && (
            <p className="text-[2rem] text-center">{`${user.nombre} ${user.apellido}`}</p>
          )}
        </div>
        <div className="h-[50%] bg-white w-[40%] rounded-xl flex flex-col items-center justify-around">
          <div className="h-[30%] w-full flex bg-primary/95 items-center px-[1rem] rounded-t-xl justify-center">
            ...
            <p className="text-[1.4rem] pl-6 text-white font-bold ">
              Usuarios activos
            </p>
          </div>
